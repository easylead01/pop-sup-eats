...
const Index = () => {
  ...
  useEffect(() => {
    if (isOverlayOpen) {
      ...
      const prevLeft = bodyStyle.left;
      const prevRight = bodyStyle.right;
      ...
      return () => {
        const lockedY = Math.abs(parseInt(bodyStyle.top || '0', 10)) || scrollY;
        htmlStyle.scrollBehavior = 'auto';
        bodyStyle.position = prevPosition;
        bodyStyle.top = prevTop;
        bodyStyle.left = prevLeft;
        bodyStyle.right = prevRight;
